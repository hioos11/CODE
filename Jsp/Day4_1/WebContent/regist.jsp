...
<body>
    ...
    <form name="regform" id="regform" method="post" action="regist_ok.jsp" onsubmit="return sendit()">
        ...
        <p>주민등록번호 : <input type="text" name="ssn1" id="ssn1" maxlength="6"> - <input type="text" name="ssn2" id="ssn2" maxlength="7"> <input type="button" id="ssnBtn" value="주민등록번호 검증"></p>
        <p><label>우편번호 : <input type="text" name="zipcode" id="sample6_postcode" placeholder="우편번호" readonly></label> <input type="button" value="우편번호 검색" onclick="sample6_execDaumPostcode()"></p>
        ...
        <p><label>참고항목 : <input type="text" name="address3" id="sample6_extraAddress" placeholder="참고항목"></label></p>
